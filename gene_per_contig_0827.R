...
data <- read.csv("I://LOEG//papers//Glauconema//gene//gene_per_contig_0827.csv",header = T)
ggplot(data, aes(x = num,..density..),color="#377eb8")+
  ...
  #ylim(0,2)
ggsave(file="I://LOEG//papers//Glauconema//gene//gene_per_contig_0827.tiff",dpi=500, width=3.5, height=3, units="in")
ggsave(file="I://LOEG//papers//Glauconema//gene//gene_per_contig_0827.pdf",dpi=500, width=3.5, height=3, units="in")